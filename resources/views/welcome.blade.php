                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                    <div class="text-uppercase">Guest &middot; Delivery</div>
                                </div>
                                <h1 class="display-4 fw-bolder"><span class="text-gradient d-inline">Selamat Datang !</span>
                                </h1>
                                <div class="fs-3 fw-light text-muted mb-4">di PT Aisin Indonesia Automotive</div>
                                <div
                                    ...
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                        href="{{ route('guest.create') }}">Guest</a>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="{{ url('sb-admin/assets/profile.png') }}"
                                        alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
